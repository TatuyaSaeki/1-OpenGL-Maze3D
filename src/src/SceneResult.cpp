...
bool SceneResult::init()
{
	...
	if(!_texture->load("data/Texture/GameOver.png")) return false;
...
//! ‰ð•ú
//======================================================================================
void SceneResult::cleanup()
{
	SAFE_DELETE(_texture);
	SceneBase::cleanup();
}

void SceneResult::menuSelection1()
{
	SceneResult::menuSelection(_menuSelectionPosition[1][0], _menuSelectionPosition[1][1], MENU_SELECTION::CONTINUE);
	SceneResult::menuSelection(_menuSelectionPosition[2][0], _menuSelectionPosition[2][1], MENU_SELECTION::BACK_TO_TITLE);
}

void SceneResult::menuRender()
{
...
void SceneResult::menuSelection(
